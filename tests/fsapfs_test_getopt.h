...
#if !defined( _FSAPFS_TEST_GETOPT_H )
#define _FSAPFS_TEST_GETOPT_H
...
#define fsapfs_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t fsapfs_test_getopt(
                  int argument_count,
...
#endif /* !defined( _FSAPFS_TEST_GETOPT_H ) */

 ...
 */
int fsapfs_test_container_get_narrow_source(
     const system_character_t *source,
     char *narrow_string,
     size_t narrow_string_size,
     libcerror_error_t **error )
{
	static char *function     = "fsapfs_test_container_get_narrow_source";
 ...
 * Returns 1 if successful or -1 on error
 */
int fsapfs_test_container_get_wide_source(
     const system_character_t *source,
     wchar_t *wide_string,
     size_t wide_string_size,
     libcerror_error_t **error )
{
	static char *function   = "fsapfs_test_container_get_wide_source";
	size_t source_length    = 0;
     ...
     const system_character_t *source )
{
	...
	/* Initialize test
	 */
	result = fsapfs_test_container_get_narrow_source(
	          source,
	          narrow_source,
	          256,
	          &error );
     ...
     const system_character_t *source )
{
	...
	/* Initialize test
	 */
	result = fsapfs_test_container_get_wide_source(
	          source,
	          wide_source,
	          256,
	          &error );
...
#endif
{
	...
	if( source != NULL )
	{
		...
		/* TODO add test for libfsapfs_container_open_file_io_handle */

...
uint8_t fsapfs_test_huffman_tree_data[ 2627 ] = {
...
/* Tests the libfsapfs_huffman_tree_initialize function
 * Returns 1 if successful or 0 if not
 */
int fsapfs_test_huffman_tree_initialize(
     void )
{
	libcerror_error_t *error             = NULL;
	libfsapfs_huffman_tree_t *huffman_tree = NULL;
	int result                           = 0;
	...
	huffman_tree = (libfsapfs_huffman_tree_t *) 0x12345678UL;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libfsapfs_huffman_tree_initialize with malloc failing
		 */
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libfsapfs_huffman_tree_initialize with memset failing
		 */
...
/* Tests the libfsapfs_huffman_tree_free function
 * Returns 1 if successful or 0 if not
 */
int fsapfs_test_huffman_tree_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
/* Tests the libfsapfs_huffman_tree_build function
 * Returns 1 if successful or 0 if not
 */
int fsapfs_test_huffman_tree_build(
     void )
{
	...
	/* Test regular cases
	 */
	result = libfsapfs_huffman_tree_build(
	          huffman_tree,
	          code_size_array,
	          288,
	          &error );
	...
	/* Test libfsapfs_huffman_tree_build with malloc failing
	 */
	...
	/* Test libfsapfs_huffman_tree_build with memset failing
	 */
...
/* Tests the libfsapfs_huffman_tree_get_symbol_from_bit_stream function
 * Returns 1 if successful or 0 if not
 */
int fsapfs_test_huffman_tree_get_symbol_from_bit_stream(
     void )
{
	uint8_t code_size_array[ 318 ];
	...
	result = libfsapfs_huffman_tree_get_symbol_from_bit_stream(
	          huffman_tree,
	          bit_stream,
	          &symbol,
	          &error );
...
#endif
{
	...
	FSAPFS_TEST_RUN(
	 "libfsapfs_huffman_tree_initialize",
	 fsapfs_test_huffman_tree_initialize );

	FSAPFS_TEST_RUN(
	 "libfsapfs_huffman_tree_free",
	 fsapfs_test_huffman_tree_free );

	FSAPFS_TEST_RUN(
	 "libfsapfs_huffman_tree_build",
	 fsapfs_test_huffman_tree_build );

	FSAPFS_TEST_RUN(
	 "libfsapfs_huffman_tree_get_symbol_from_bit_stream",
	 fsapfs_test_huffman_tree_get_symbol_from_bit_stream );

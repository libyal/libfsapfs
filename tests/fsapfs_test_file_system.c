...
#include "../libfsapfs/libfsapfs_file_system.h"

#if defined( __GNUC__ ) && !defined( LIBFSAPFS_DLL_IMPORT )

/* Tests the libfsapfs_file_system_initialize function
     ...
     void )
{
	...
	result = libfsapfs_file_system_free(
	          &file_system,
	          &error );
	...
	file_system = (libfsapfs_file_system_t *) 0x12345678UL;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libfsapfs_file_system_initialize with malloc failing
		 */
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libfsapfs_file_system_initialize with memset failing
		 */
...
/* Tests the libfsapfs_file_system_free function
 * Returns 1 if successful or 0 if not
 */
int fsapfs_test_file_system_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
#endif
{
	...
	FSAPFS_TEST_RUN(
	 "libfsapfs_file_system_initialize",
	 fsapfs_test_file_system_initialize );

	FSAPFS_TEST_RUN(
	 "libfsapfs_file_system_free",
	 fsapfs_test_file_system_free );

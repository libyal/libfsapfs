/*
 * Library object_map_descriptor type test program
 *
...
/* Tests the libfsapfs_object_map_descriptor_initialize function
     ...
     void )
{
	...
	/* Test regular cases
	 */
	result = libfsapfs_object_map_descriptor_initialize(
	...
	result = libfsapfs_object_map_descriptor_free(
	          &object_map_descriptor,
	          &error );
	...
	object_map_descriptor = (libfsapfs_object_map_descriptor_t *) 0x12345678UL;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libfsapfs_object_map_descriptor_initialize with malloc failing
		 */
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libfsapfs_object_map_descriptor_initialize with memset failing
		 */
...
/* Tests the libfsapfs_object_map_descriptor_free function
 * Returns 1 if successful or 0 if not
 */
int fsapfs_test_object_map_descriptor_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
#endif
{
	...
	FSAPFS_TEST_RUN(
	 "libfsapfs_object_map_descriptor_initialize",

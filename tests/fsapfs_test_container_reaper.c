...
#include "../libfsapfs/libfsapfs_container_reaper.h"

uint8_t fsapfs_test_container_reaper_data1[ 4096 ] = {
	,
...
/* Tests the libfsapfs_container_reaper_initialize function
     ...
     void )
{
	...
	/* Test regular cases
	 */
	result = libfsapfs_container_reaper_initialize(
	          &container_reaper,
	          &error );
	...
	result = libfsapfs_container_reaper_free(
	          &container_reaper,
	          &error );
	...
	container_reaper = (libfsapfs_container_reaper_t *) 0x12345678UL;
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libfsapfs_container_reaper_initialize with malloc failing
		 */
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		/* Test libfsapfs_container_reaper_initialize with memset failing
		 */
...
/* Tests the libfsapfs_container_reaper_free function
 * Returns 1 if successful or 0 if not
 */
int fsapfs_test_container_reaper_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
/* Tests the libfsapfs_container_reaper_read_file_io_handle function
 * Returns 1 if successful or 0 if not
 */
     ...
     void )
{
	...
	result = fsapfs_test_open_file_io_handle(
	          &file_io_handle,
	          fsapfs_test_container_reaper_data1,
	          4096,
	          &error );
	...
	/* Test regular cases
	 */
	result = libfsapfs_container_reaper_read_file_io_handle(
	          container_reaper,
	          file_io_handle,
	          0,
	          &error );
...
/* Tests the libfsapfs_container_reaper_read_data function
 * Returns 1 if successful or 0 if not
 */
     ...
     void )
{
	...
	/* Test regular cases
	 */
	result = libfsapfs_container_reaper_read_data(
	          container_reaper,
	          fsapfs_test_container_reaper_data1,
	          4096,
	          &error );
...
#endif
{
	...
	FSAPFS_TEST_RUN(
	 "libfsapfs_container_reaper_initialize",
	 fsapfs_test_container_reaper_initialize );

	FSAPFS_TEST_RUN(
	 "libfsapfs_container_reaper_free",
	 fsapfs_test_container_reaper_free );

	FSAPFS_TEST_RUN(
	 "libfsapfs_container_reaper_read_file_io_handle",
	 fsapfs_test_container_reaper_read_file_io_handle );

	FSAPFS_TEST_RUN(
	 "libfsapfs_container_reaper_read_data",
	 fsapfs_test_container_reaper_read_data );

...
LIBRARY_TESTS="btree_entry btree_footer btree_header btree_root checkpoint_map checkpoint_map_entry container_reaper container_space_manager container_superblock error file_system_btree io_handle key_bag_entry key_bag_header notify object object_map object_map_btree object_map_descriptor";

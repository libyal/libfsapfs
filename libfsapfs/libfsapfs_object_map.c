     ...
     libcerror_error_t **error )
{
	...
	byte_stream_copy_to_uint64_little_endian(
	 ( (fsapfs_object_map_t *) data )->object_map_btree_block_number,
	...
	if( libcnotify_verbose != 0 )
	{
		...
		byte_stream_copy_to_uint32_little_endian(
		 ( (fsapfs_object_map_t *) data )->unknown4,
		 value_32bit );
		libcnotify_printf(
		...
		byte_stream_copy_to_uint64_little_endian(
		 ( (fsapfs_object_map_t *) data )->unknown6,
		 value_64bit );
		libcnotify_printf(
		 "%s: unknown6\t\t\t\t: %" PRIu64 "\n",
		 function,
		...
		byte_stream_copy_to_uint64_little_endian(
		 ( (fsapfs_object_map_t *) data )->unknown7,
		 value_64bit );
		libcnotify_printf(
		 "%s: unknown7\t\t\t\t: %" PRIu64 "\n",
		 function,

...
/* Creates data stream from a buffer
...
{
	libfsapfs_buffer_data_stream_handle_t *data_stream_handle = NULL;
	static char *function                                     = "libfsapfs_data_stream_initialize_from_buffer";
	int segment_index                                         = 0;
	...
	if( libfsapfs_buffer_data_stream_handle_initialize(
	     &data_stream_handle,
	     buffer,
	     buffer_size,
	     error ) != 1 )
	{
		libcerror_error_set(
		 ...
		 "%s: unable to create buffer data stream handle.",
		 function );
	...
	if( libfdata_stream_initialize(
	     ...
	     (int (*)(intptr_t **, libcerror_error_t **)) &libfsapfs_buffer_data_stream_handle_free,
	     NULL,
	     NULL,
	     (ssize_t (*)(intptr_t *, intptr_t *, int, int, uint8_t *, size_t, uint32_t, uint8_t, libcerror_error_t **)) &libfsapfs_buffer_data_stream_handle_read_segment_data,
	     NULL,
	     (off64_t (*)(intptr_t *, intptr_t *, int, int, off64_t, libcerror_error_t **)) &libfsapfs_buffer_data_stream_handle_seek_segment_offset,
	     ...
	     error ) != 1 )
	{
		libcerror_error_set(
		 ...
		 "%s: unable to append buffer as data stream segment.",
		 function );
...
on_error:
	...
	{
		libfsapfs_buffer_data_stream_handle_free(
		 &data_stream_handle,
		 NULL );
	}
	return( -1 );
...
int libfsapfs_data_stream_initialize_from_file_extents(
     ...
     libcerror_error_t **error )
{
	libfsapfs_data_block_data_stream_handle_t *data_stream_handle = NULL;
	...
	if( libfsapfs_data_block_data_stream_handle_initialize(
	     &data_stream_handle,
	     io_handle,
	     volume_data_handle,
	     error ) != 1 )
	...
	if( libfdata_stream_initialize(
	     data_stream,
	     (intptr_t *) data_stream_handle,
	     (int (*)(intptr_t **, libcerror_error_t **)) &libfsapfs_data_block_data_stream_handle_free,
	     NULL,
	     NULL,
	     (ssize_t (*)(intptr_t *, intptr_t *, int, int, uint8_t *, size_t, uint32_t, uint8_t, libcerror_error_t **)) &libfsapfs_data_block_data_stream_handle_read_segment_data,
	     NULL,
	     (off64_t (*)(intptr_t *, intptr_t *, int, int, off64_t, libcerror_error_t **)) &libfsapfs_data_block_data_stream_handle_seek_segment_offset,
	     LIBFDATA_DATA_HANDLE_FLAG_MANAGED,
	     error ) != 1 )
	{
		libcerror_error_set(
...
on_error:
	...
	if( data_stream_handle != NULL )
	{
		libfsapfs_data_block_data_stream_handle_free(
		 &data_stream_handle,
		 NULL );
	}
	return( -1 );

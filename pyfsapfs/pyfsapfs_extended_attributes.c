...
PySequenceMethods pyfsapfs_extended_attributes_sequence_methods = {
	/* sq_length */
	(lenfunc) pyfsapfs_extended_attributes_len,
	/* sq_concat */
	0,
	/* sq_repeat */
	0,
	/* sq_item */
	(ssizeargfunc) pyfsapfs_extended_attributes_getitem,
	/* sq_slice */
	0,
	/* sq_ass_item */
	0,
...
PyTypeObject pyfsapfs_extended_attributes_type_object = {
	PyVarObject_HEAD_INIT( NULL, 0 )

	/* tp_name */
	"pyfsapfs.extended_attributes",
	/* tp_basicsize */
	sizeof( pyfsapfs_extended_attributes_t ),
	/* tp_itemsize */
	0,
	/* tp_dealloc */
	(destructor) pyfsapfs_extended_attributes_free,
	/* tp_print */
	0,
	/* tp_getattr */
	0,
	...
	0,
	/* tp_as_sequence */
	&pyfsapfs_extended_attributes_sequence_methods,
	/* tp_as_mapping */
	0,
	/* tp_hash */
	0,
	...
	/* tp_doc */
	"pyfsapfs sequence and iterator object of extended attributes",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
	...
	0,
	/* tp_iter */
	(getiterfunc) pyfsapfs_extended_attributes_iter,
	/* tp_iternext */
	(iternextfunc) pyfsapfs_extended_attributes_iternext,
	/* tp_methods */
	0,
	/* tp_members */
	0,
	...
	0,
	/* tp_init */
	(initproc) pyfsapfs_extended_attributes_init,
	/* tp_alloc */
	0,
	/* tp_new */
	0,
...
PyObject *pyfsapfs_extended_attributes_new(
           ...
           int number_of_items )
{
	pyfsapfs_extended_attributes_t *sequence_object = NULL;
	static char *function                           = "pyfsapfs_extended_attributes_new";
...
/* Intializes an extended attributes sequence and iterator object
 * Returns 0 if successful or -1 on error
 */
int pyfsapfs_extended_attributes_init(
     pyfsapfs_extended_attributes_t *sequence_object )
{
	static char *function = "pyfsapfs_extended_attributes_init";
      ...
      pyfsapfs_extended_attributes_t *sequence_object )
{
	...
	static char *function       = "pyfsapfs_extended_attributes_free";
...
Py_ssize_t pyfsapfs_extended_attributes_len(
            pyfsapfs_extended_attributes_t *sequence_object )
{
	static char *function = "pyfsapfs_extended_attributes_len";
           ...
           Py_ssize_t item_index )
{
	...
	static char *function               = "pyfsapfs_extended_attributes_getitem";
...
PyObject *pyfsapfs_extended_attributes_iter(
           pyfsapfs_extended_attributes_t *sequence_object )
{
	static char *function = "pyfsapfs_extended_attributes_iter";
...
{
	PyObject *extended_attribute_object = NULL;
	static char *function               = "pyfsapfs_extended_attributes_iternext";
